...
const SessionBlankState = () => {
  ...
  return (
    <div className="mt-1 flex items-center justify-center rounded-lg bg-gray-100 pb-6 pt-4">
      <div className="flex flex-col items-center gap-1">
        <HistoryBlankStateIcon />
        <div className="flex flex-col items-center gap-2">
          <h3 className="text-sm font-medium">No Session found</h3>
          <p className="max-w-[210px] text-center text-sm">{errorMessage}</p>
        </div>
      </div>
    </div>
  )
